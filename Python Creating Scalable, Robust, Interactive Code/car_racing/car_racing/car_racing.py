# Welcome to the Python 500 race! 


import random
#set top speed
car1_top_speed = random.randint(0,50)
car2_top_speed = random.randint(0,50)
#set acceletation of both cars
car1_acceleration = random.randint(0,10)
car2_acceleration = random.randint(0,10)
